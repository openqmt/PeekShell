    ...
    <div v-if="open" class="quick-commands-panel" @mousedown.stop>
        ...
        <div v-if="creating || editing" class="qc-form">
            ...
            <div class="qc-form-actions">
                ...
                <button type="button" class="btn primary" @click="saveForm">
                    {{ t('common.save') }}
                </button>
            </div>
        </div>
        ...
        <div class="qc-body">
            <div v-if="!grouped.length" class="qc-empty">
            ...
            >
                ...
                >
                    <span class="chev" :class="{ open: isGroupOpen(group) }"
                        >›</span
                    >
                ...
                <div v-show="isGroupOpen(group)" class="qc-list">
                    <div v-if="!list.length" class="qc-empty-group">
                        {{ t('quickCommands.emptyGroup') }}
                    </div>
